...
<footer class="bg-dark text-white py-3">
    <nav class="container d-flex justify-content-between align-items-center">
        ...
        <ul class="nav ms-auto">
            ...
            <li class="nav-item ms-3">
                <a href="https://t.me/" class="nav-link text-white">Телеграм</a>
            </li>
            <li class="nav-item ms-3">
                <a href="https://instagram.com/" class="nav-link text-white">Инстаграм</a>
            </li>
        </ul>
    </nav>
    <p class="text-center mb-4">&copy; 2025 TajBooks. Все права защищены.</p>
</footer>
